...
const GetStartedSection = () => {
    return (
        <div id='get-started' className='relative w-11/12 lg:w-5/6 xl:w-3/4 mx-auto flex flex-col justify-between items-center py-16 md:py-20 lg:py-24 gap-4 lg:gap-8'>
            ...
            <div className='w-full mx-auto h-full top-0 left-1/2 transform -translate-x-1/2 absolute z-[-1] rounded-lg bg-gradient-to-tl from-tertiary/10 to-primary/40 opacity-90 shadow-lg shadow-primary/30'/>
